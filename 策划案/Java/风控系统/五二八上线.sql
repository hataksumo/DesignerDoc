...
ALTER TABLE jh_rule_task_version ADD COLUMN time_field text null comment "数据表时间字段名";
...
ALTER TABLE jh_rule_task_version ADD COLUMN group_phase varchar(100) null comment "分组字段";
