...
public class RCode {
     ...
     * 没有实现
     */
    public static final int API_CODE_CALL_UNIMPLEMENTED = -1;
    /**
     * 成功
     */
     ...
     * 业务逻辑失败
     * */
    public static final int API_CODE_CALL_Login_Fail = 201;
    /**
     * 权限错误
     */
    public static final int API_CODE_PRIVILEGE_ERR = 202;
