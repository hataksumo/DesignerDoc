...
function EntityAttr:gen_battle_attr(v_bRefresh,v_bCalBuff)
	if v_bCalBuff then
	...
	battle_attr.element_atk = battle_attr.element_atk * (1 + battle_attr.magnify_element_atk)
	for _i=1,4 do
...
function EntityAttr:get_battle_score()
	self:gen_battle_attr(false,false)
	local rtn = 0
