...
ATTRIBUTE_INFO.data = {
	...
	[7] = {id = 7,ename = "crit",cname = "暴击等级",value_type = 1,battle_score_fac = 3},--角色的暴击能力，初始暴击伤害为200%
	[8] = {id = 8,ename = "decrit",cname = "抗暴等级",value_type = 1,battle_score_fac = 3},--角色对抗暴击的能力
	[9] = {id = 9,ename = "hit",cname = "命中等级",value_type = 1,battle_score_fac = 3},--角色命中的能力
	[10] = {id = 10,ename = "dodge",cname = "闪避等级",value_type = 1,battle_score_fac = 3},--角色闪避的能力
	[11] = {id = 11,ename = "block",cname = "格挡等级",value_type = 1,battle_score_fac = 3},--角色格挡的能力
	[12] = {id = 12,ename = "dash",cname = "冲击等级",value_type = 1,battle_score_fac = 3},--角色对抗格挡的能力
	...
	[21] = {id = 21,ename = "def_concern",cname = "坚实",value_type = 2},--减少无视防御的概率
